#!/usr/bin/env python3
"""Простой веб-сервер для NoteCaddy"""
...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .note-header { display: flex; justify-content: space-between; margin-bottom: 12px; border-bottom: 1px solid #374151; padding-bottom: 12px; }
        .note-id { color: #00d9ff; font-weight: bold; }
        .note-date { color: #9ca3af; font-size: 13px; margin-left: 10px; }
        .note-text { background: #111827; padding: 12px; border-radius: 8px; white-space: pre-wrap; }
    </style>
</head>
<body>
    <div class="container">
...
def process_text(raw):
    ...
    summary = dates[0] if dates else (processed[0] if processed else raw[:50])
